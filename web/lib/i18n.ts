...
export const T = {
  zh: {
    ...
    preview: {
      ...
      addPage: "添加页",
      addPageHint: "在简历末尾追加一张空白页，可以放浮动文本框 / 图片 / 形状",
      removePageHint: "移除最后一张手动添加的空白页",
      extraPagesHint: "其中手动添加的空白页数",
  ...
  en: {
    ...
    preview: {
      ...
      addPage: "Add page",
      addPageHint: "Append a blank page below the resume — drop floating text boxes / images / shapes onto it",
      removePageHint: "Remove the last manually-added blank page",
      extraPagesHint: "Manually added blank pages",
